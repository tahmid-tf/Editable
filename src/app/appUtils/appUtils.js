...
export const getMaxThreshold = (thresholdsData, editsData) => {
	...
	relevantThresholds.skinRetouching = editsData?.skinRetouching ? thresholdsData?.category?.skin_retouch_threshold || 0 : 0;
	relevantThresholds.previewEdits = editsData?.previewEdits ? thresholdsData?.category?.preview_edit_threshold || 0 : 0;
