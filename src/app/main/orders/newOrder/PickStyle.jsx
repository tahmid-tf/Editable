...
const PickStyle = ({ onPickStyleSubmit, successAlert }) => {
	...
	const handleMainStyleClick = async (e, id, additionalId, setFieldValue) => {
					...
					<div className="flex">
						<div className="">
							...
							<div className="pr-[100px]">
									...
									{styleData.map((styleInfo, i) => (
										...
										>
											<Field
												...
												handleChange={(e) =>
													handleMainStyleClick(
														e,
														styleInfo.id,
														values?.selectedAdditionalStyleId,
														setFieldValue
													)
												}
											/>
								...
								<div className="mt-60">
									<div>
										<p className="text-[32px] font-bold text-[#422323] py-36">Additional Edits</p>
									</div>
										...
										<div className="flex items-center mt-[30px]">
											...
											>
												...
												<span
													className={clsx(
														'pl-5 text-[20px] font-bold',
														data?.skin_retouch === 'yes' ? 'text-black' : 'text-[#868686]'
													)}
												>
													Skin Retouching
												</span>
										...
										<Tooltip
											...
											title={
												<span
													...
													className=""
												>
													The Preview Edit service provides a preview of approximately 10% of
													the culled or final editable images, for your consideration and
													approval.
												</span>
											}
											componentsProps={{
								...
								<div className="my-60">
									<div>
										<p className="text-[32px] font-bold text-[#868686] pt-36">Additional Info</p>
									</div>
									{/* showCullingInputs */}
								...
								<div className="w-[400px] text-[12px] font-medium">
									...
									<div className="pl-5">
										<div className="flex">
											<p>1.</p>
											<p className="pl-8">
												All the images have finished uploading in the drive before placing the
												order.
											</p>
										</div>
										<div className="flex">
											<p>2.</p>
											<p className="pl-5">
												Your images are either RAW photos, JPG photos, or Smart Preview Enabled
												Lightroom Catalogs.
											</p>
										</div>
									</div>
