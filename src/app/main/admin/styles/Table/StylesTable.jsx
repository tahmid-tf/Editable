...
import { Grid, Modal, Pagination, TextField } from '@mui/material';
...
function StylesTable({ deleteAlert, successAlert, errorAlert }) {
	...
	const requiredColumns = new Set(['Name', 'Additional Style', 'Categories', 'Additional Edits', 'Image', '']);
	...
	const filterRows = (rows) => {
		return rows.filter((row) => {
			const matchesSearchValue = row.name.toLowerCase().includes(searchValue.toLowerCase());
			...
			<div className="">
				<div className="">
					<Grid
						container
						spacing={2}
						className="py-10 justify-between"
					>
						<Grid item>
							{/* <TextField
                sx={{
